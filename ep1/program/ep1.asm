...
section .text
    ...
    ;; Printing Units
    ; If (unit > 100)
    ;   decrement by 100 until unit < 100 and increment hundreds, then print hundreds
    ; If (unit > 10)
    ;   decrement by 10 until unit < 10 and increment tens, then pŕint tens
    ; Then Unit
    ...
    ;; e.g.: unit = 101
    ;	 if (unit > 101)
    ;		unit = unit - 100  (hundreds = 1)
    ;	 we will have unit = 01
    ;	 if (unit < 10 && hundreds > 0)
    ;		print extra '0'
    print0:	
    	mov eax, 0
    	add eax, '0'
